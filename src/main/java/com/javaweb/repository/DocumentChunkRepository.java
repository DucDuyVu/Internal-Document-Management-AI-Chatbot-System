...
public interface DocumentChunkRepository extends JpaRepository<DocumentChunkEntity, Long> {
     ...
     * Output:
     *   List<SearchResult> - đã sắp xếp theo similarity tăng dần (gần nhất
     *   trước, vì "<=>" là KHOẢNG CÁCH: giá trị càng NHỎ càng liên quan)
     *
     * Lưu ý: cố tình KHÔNG SELECT cột "embedding" (không cần dùng lại vector
     * gốc sau khi đã tính xong similarity trong SQL - tránh kéo 3072 số thực
