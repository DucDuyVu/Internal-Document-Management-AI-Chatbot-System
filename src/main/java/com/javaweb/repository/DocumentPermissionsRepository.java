...
public interface DocumentPermissionsRepository extends JpaRepository<DocumentPermissionsEntity, Long> {
        ...
        boolean existsByPermissionsDocumentId_IdAndPermissionDepartmentId_IdAndRevokedAtIsNull(Long documentId,
                        Long departmentId);

        Optional<DocumentPermissionsEntity> findByPermissionsDocumentId_IdAndPermissionDepartmentId_IdAndRevokedAtIsNull(
                        Long documentId, Long departmentId);

        boolean existsByPermissionsDocumentId_IdAndPermissionDepartmentIdIsNullAndRevokedAtIsNull(Long documentId);

        Optional<DocumentPermissionsEntity> findByPermissionsDocumentId_IdAndPermissionDepartmentIdIsNullAndRevokedAtIsNull(
                        Long documentId);
        ...
        @Query("""
                        ...
                        ORDER BY p.createdAt DESC
                        """)
        List<DocumentPermissionsEntity> findActivePermissionsByDepartmentId(
